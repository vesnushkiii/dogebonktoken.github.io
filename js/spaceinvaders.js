...
WelcomeState.prototype.draw = function (game, dt, ctx) {
  ...
  ctx.fillText("Bonk Invaders", game.width / 2, game.height / 2 - 40);
  ctx.font = "24px Patrick Hand";

  ctx.fillText(
    "Protect your bonk from the FUD invaders who try to shoot red shitcoins at you.",
    game.width / 2,
    game.height / 2
  );
  ctx.fillText(
    "Bonk the 'Space' key or touch to start.",
    game.width / 2,
    game.height / 2 + 40
  );
};
...
GameOverState.prototype.draw = function (game, dt, ctx) {
  ...
  ctx.font = "24px Patrick Hand";
  ctx.fillText(
    "Bonk the 'Space' key to play again.",
    game.width / 2,
    game.height / 2 + 40
  );
};
...
PlayState.prototype.draw = function (game, dt, ctx) {
  ...
  for (var i = 0; i < this.rockets.length; i++) {
    var rocket = this.rockets[i];
    ctx.fillRect(rocket.x, rocket.y - 2, 5, 22);
  }
